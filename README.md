...
<li>Change the connection strings inside the School.Data/App.config and School.Web/Web.config
   accoarding to your development environment</li>
<li>Open Package Manager Console</li>
<li>Select School.Data as Default project (in package manager console) and run the following commands
   <ol>
   <li>add-migration "initial"</li>
   <li>update-database -verbose</li>
   </ol></li>
<li>Run School.Web application</li>
<li>Use <i>username:</i> <strong>chsakell</strong>, <i>password:</i> <strong>School</strong> to login or register a new account</li>
</ol>
